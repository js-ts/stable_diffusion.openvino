...
if __name__ == "__main__":
    ...
    # pipeline configure
    parser.add_argument("--model", type=str, default="./stable-diffusion-v1-4-openvino", help="model name")
    # randomizer params
    ...
    # tokenizer
    parser.add_argument("--tokenizer", type=str, default="./clip-vit-large-patch14", help="tokenizer")
    # prompt
